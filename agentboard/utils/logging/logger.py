...
class TaskLogger:
    ...
    def save_sample_data_to_file_detailed(self, id, is_done, reward, grounding_accuracy, score_change_record, env_details, trajectory, example_prompt, extra=None):
        if self.task_name not in ["webarena"]:
            is_done = bool(is_done)
        reward = float(reward)
        grounding_accuracy = float(grounding_accuracy)
        ...
        sample_result["extra_record"] = extra
    ...
    def log_example(self, id, is_done, reward, grounding_accuracy, score_change_record, env_details, trajectory, example_prompt=None, extra=None):
        self.save_sample_data_to_file_detailed(id, is_done, reward, grounding_accuracy, score_change_record, env_details, trajectory, example_prompt, extra=extra) # log to file
