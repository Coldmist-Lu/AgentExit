...
class EvalJericho(BaseTask):
    ...
    def evaluate_env(self, id):
        ...
        goal = env._get_goal()
        self.agent.task_id = f"jericho_{id}" # add task id for history load
        ...
        for step_id in range(max_steps):
            ...
            if done:
                ...
                self.agentboard.log_example(id, True, progress_rate, grounding_acc_count / (step_id + 1), score_change_record, env_details, trajectory, extra=extra_details)
